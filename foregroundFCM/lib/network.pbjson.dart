...
final $typed_data.Uint8List exMessageDescriptor = $convert.base64Decode(
    'CglFeE1lc3NhZ2USFAoFcm91dGUYASABKA1SBXJvdXRlEhMKBWd3X2lkGAIgASgNUgRnd0lkEhsKCWRldmljZV9pZBgDIAEoBFIIZGV2aWNlSWQSGwoJZGF0YV91bml0GAQgASgMUghkYXRhVW5pdA==');
...
final $typed_data.Uint8List rtuMessageDescriptor = $convert.base64Decode(
    'CgpSdHVNZXNzYWdlEhgKB2NoYW5uZWwYASABKA1SB2NoYW5uZWwSJwoPc2VxdWVuY2VfbnVtYmVyGAIgASgNUg5zZXF1ZW5jZU51bWJlchITCgVnd19pZBgDIAEoDVIEZ3dJZBIbCglkZXZpY2VfaWQYBCABKARSCGRldmljZUlkEhsKCWRhdGFfdW5pdBgFIAEoDFIIZGF0YVVuaXQ=');
...
final $typed_data.Uint8List extMessageDescriptor = $convert.base64Decode(
    'CgpFeHRNZXNzYWdlEhgKB2NvbnRleHQYASABKARSB2NvbnRleHQSEwoFZ3dfaWQYAiABKA1SBGd3SWQSGwoJZGV2aWNlX2lkGAMgASgEUghkZXZpY2VJZBIbCglkYXRhX3VuaXQYBCABKAxSCGRhdGFVbml0');
...
final $typed_data.Uint8List cmdMessageDescriptor = $convert.base64Decode(
    'CgpDbWRNZXNzYWdlEhcKB29wX2NvZGUYASABKA1SBm9wQ29kZRIUCgVyb3V0ZRgCIAEoDVIFcm91dGUSGgoIYXJndW1lbnQYAyABKA1SCGFyZ3VtZW50EhMKBWd3X2lkGAQgASgNUgRnd0lkEhsKCWRldmljZV9pZBgFIAEoBFIIZGV2aWNlSWQSGAoHcGF5bG9hZBgGIAEoDFIHcGF5bG9hZA==');
